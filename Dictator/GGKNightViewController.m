...
- (IBAction)showNightActions {
    ...
    NSArray *theChoosePlayerRoleArray = @[GGKTownspersonKeyString, GGKDoctorKeyString, GGKGossipKeyString, GGKHermitKeyString, GGKPrivateEyeKeyString, GGKVigilanteKeyString];
