...
- (id)initWithType:(NSString *)theRoleKey {
    ...
    if (self) {
        ...
        if ([self.key isEqualToString:GGKTownspersonKeyString]) {
            ...
            self.isTraitor = YES;
            self.shortBlurb = [NSString stringWithFormat:@"votes to %@ a player at night", GGKEliminateString];
            ...
            self.longNameWithArticle = [NSString stringWithFormat:@"a %@", self.name];
            self.shortBlurb = @"investigate a player at night";
            ...
            self.name = @"Doctor";
            self.longNameWithArticle = [NSString stringWithFormat:@"a %@", self.name];
            self.shortBlurb = @"protect a player at night";
            ...
            self.name = @"Vigilante";
            self.longNameWithArticle = [NSString stringWithFormat:@"a %@", self.name];
            self.shortBlurb = [NSString stringWithFormat:@"%@ a player at night", GGKEliminateString];
            ...
            self.longNameWithArticle = [NSString stringWithFormat:@"a %@", self.name];
            self.isTraitor = YES;
            self.shortBlurb = @"appears to be Townsperson";
            ...
            self.name = @"Hermit";
            self.longNameWithArticle = [NSString stringWithFormat:@"a %@", self.name];
            self.shortBlurb = @"exiled if elected Dictator; disables Traitors that night";
            ...
            self.name = @"Gossip";
            self.longNameWithArticle = [NSString stringWithFormat:@"a %@", self.name];
            self.shortBlurb = @"block a player from being Dictator";
